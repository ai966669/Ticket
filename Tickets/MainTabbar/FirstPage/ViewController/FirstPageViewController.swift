...
class FirstPageViewController: UIViewController {
    ...
    func initTableviewTicketFisrtPage(){
        ...
        self.aFirstPageTableDataSource=FirstPageTableDataSource.init(aMFirstPageTableView: self.aMFirstPageTableView,tableView: self.tableviewTicketFisrtPage)
            self.tableviewTicketFisrtPage.delegate = self.aFirstPageTableDataSource;
